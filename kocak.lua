...
local function webhook(raised, donor)
    ...
    local embed = {
        title = "✨ SCRIPT BY NEAR ✨",
        description = string.format(
            "**%s** 💸 just received **%d R$** from **%s**!\n\n" ..
            "📉 After Tax: `%d R$`\n" ..
            "📈 Total Raised: `%d R$`",
        ...
        color = 0x00FFCC, -- cyan biar fresh
        thumbnail = {
        ...
        image = {
            url = "https://cdn.discordapp.com/attachments/1409664349441884180/1409722429571596391/a.gif?ex=68ae69d2&is=68ad1852&hm=2030374ff7b01efc239f0ec5d57901b87ba9b109ae27fa78a322ad419379f9a2&" -- ✅ GIF ditampilkan di bawah embed
        },
